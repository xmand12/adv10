...
//== CONSTANT CLASS ATTRIBUTES =================================================
    ...
    static final IRoomManager ROOM_MANAGER =
//                              Room1ManagerAdapter.getInstance();
                              Room2Manager.getInstance();

    /** Odkaz na instanci správce příkazů.
     *  Je-li správcem příkazů třída příkazů, použije se adaptér. */
    static final ICommandManager COMMAND_MANAGER =
//                              Command1ManagerAdapter.getInstance();
