...
import static cz.vse.adv_framework.scenario.AScenarioManager.HAPPY_SCENARIO;
...
//== CONSTANT CLASS ATTRIBUTES =================================================
    ...
    private static final String[] GUI_SCENARIO_COMMANDS = {
        "vezmi deštník",
        "jdi   koupelna",
        "vezmi brýle",
        "polož deštník",
...
//== STATIC INITIALIZER (CLASS CONSTRUCTOR) ====================================
    ...
    static {
        //Ze "šťastného scénáře" vytvoří kroky pro demonstrační scénář
        int number = HAPPY_SCENARIO.length();
        List<String> steps = new ArrayList<>(number);
        for (ScenarioStep scenarioStep : HAPPY_SCENARIO_STEPS) {
            String command = scenarioStep.command;
            steps.add(command);
        }
        DEMO_SCENARIO = steps.toArray(new String[number]);
    }
...
//== CONSTUCTORS AND FACTORY METHODS ===========================================
    ...
    private ManagerWithLiterals()
    {
        ...
        addScenario("Demo pro GUI",            GUI_SCENARIO_COMMANDS);
        seal();
    }
