...
/*
    /** Logger, prostřednictvím nějž zanamenáváme potřebné informace. *
    private final static DBG_Logger DBG = DBG_Logger.getInstance();
*/
/*******************************************************************************
 * Instance třídy {@code DBG_Logger} představují ...
 *
...
//== CONSTANT CLASS ATTRIBUTES =================================================
    ...
    private static final DBG_Logger jedináček = new DBG_Logger();

    private static String STOPKA = "STOP";
...
//== OTHER NON-PRIVATE INSTANCE METHODS ========================================
     ...
     */
    public void severe(String formát, Object parametr)
    {
        log(Level.SEVERE, formát, parametr);
    }
