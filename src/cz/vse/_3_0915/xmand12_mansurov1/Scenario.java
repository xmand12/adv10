...
//== CONSTANT CLASS ATTRIBUTES =================================================
     ...
     */
     private static final ScenarioStep START_STEP =
        new ScenarioStep(tsSTART,
            "",
                      "Vy jste známý španělský korsar.\n "
     ...
     private static final ScenarioStep[] SCENARIO_STEPS_HW_10 =
    {
     ...
     private static final ScenarioStep[] RESTART =
    {
        START_STEP,
        ...
        new ScenarioStep(TypeOfStep.tsNON_STANDARD,
            "restart",
            "Přesunul(a) jste do prostoru restartující hru",
...
//== CONSTUCTORS AND FACTORY METHODS ===========================================
    ...
    private Scenario()
    {
        ...
        addScenario("Restart", TypeOfScenario.scGENERAL, RESTART);
         addScenario("DU_10",
